...
\subsubsection*{Other layers}
 Pooling
\begin{itemize}
    \item \textbf{Max-pooling k$_1$\x k$_2$ /s} : maximum pooling with kernel size \textit{k$_1$\x k$_2$} and stride \textit{s}.
    
    \item \textbf{Max-pooling k$_1$\x k$_2$ p:P} : maximum pooling with
