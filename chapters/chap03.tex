...
Thanks to the convolution, we reduced the number of trainable parametrs from $n^4cP$ in naive approach to $k^2cP$, where \textit{k} is ussually a small number, i.e. \textit{k = 3}, and number of multiplications to $n^2k^2cP$.
